...
$(document).ready(function () {
    ...
    $(document).on("click", 'a[data-ajax-edit-flyer="true"]', function () {
        var title = $(this).data("title");
        var size = $(this).data("size") == "" ? "md" : $(this).data("size");
        var url = $(this).data("url");
        var data_action = $(this).data("action");
    ...
    $(document)
        .off("submit", "#flyersEditForm")
        .on("submit", "#flyersEditForm", function (e) {
            e.preventDefault();
            var form = $(this);
            var submitButton = form.find('button[type="submit"]');
    ...
    $(document).on("click", ".show_confirm_delete_flyers", function (e) {
        e.preventDefault();
